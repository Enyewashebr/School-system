...
function CreateNews() {
  ...
  const handleSubmit = (event) => {
    ...
    // Later this will call the Node.js API.
    alert(
    ...
    <div className="p-6 md:p-8">
      ...
      <div className="mt-6">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Create a news article for students, parents, and the public.
        </p>
      </div>
      ...
      >
        ...
        <section className="rounded-xl bg-white shadow-sm">
          ...
          <div className="border-b border-gray-100 px-6 py-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Enter the main information for the news article.
            </p>
          </div>
          ...
          <div className="space-y-6 p-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">
                Write the complete information that will be displayed
        ...
        <section className="mt-6 rounded-xl bg-white shadow-sm">
          ...
          <div className="border-b border-gray-100 px-6 py-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Add an image that represents this news article.
            </p>
        ...
        <section className="mt-6 rounded-xl bg-white shadow-sm">
          ...
          <div className="border-b border-gray-100 px-6 py-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Choose whether to save this article as a draft or publish it.
            </p>
            ...
            <div className="space-y-3">
              ...
              <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4 hover:bg-gray-50">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    The news will not appear on the public website.
                  </p>
                </div>
              ...
              <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4 hover:bg-gray-50">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    The news will become visible on the public website.
                  </p>
                </div>
